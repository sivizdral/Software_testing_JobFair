 ...
 * @author korisnik
 */
public class TP33_grad_i_adresa_prazni {
    
    public TP33_grad_i_adresa_prazni() {
    }

    @Test
    public void registracijaKompanijaTest33() {
        ...
        Assert.assertTrue(tekst.equals("Grad nije ispravno unet!\n" +
"Adresa nije ispravno uneta!"));
