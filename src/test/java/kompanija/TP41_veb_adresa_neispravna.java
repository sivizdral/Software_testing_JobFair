 ...
 * @author korisnik
 */
public class TP41_veb_adresa_neispravna {
    
    public TP41_veb_adresa_neispravna() {
    }

    @Test
    public void registracijaKompanijaTest41() {
        ...
        String vebAdresa = "wwwjanestreetcom";
        String delatnost = "IT";
        ...
        Assert.assertTrue(tekst.equals("WEB stranica nije ispravno uneta!"));
