 ...
 * @author korisnik
 */
public class TP32_naziv_kompanije_prazan {
    
    public TP32_naziv_kompanije_prazan() {
    }
@Test
    public void registracijaKompanijaTest32() {
        ...
        Assert.assertTrue(tekst.equals("Naziv nije ispravno unet!"));
