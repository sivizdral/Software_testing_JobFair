 ...
 * @author korisnik
 */
public class TP34_direktor_prazan {
    
    public TP34_direktor_prazan() {
    }
@Test
    public void registracijaKompanijaTest34() {
        ...
        Assert.assertTrue(tekst.equals("Direktor nije ispravno unet!"));
