 ...
 * @author korisnik
 */
public class TP49_nema_teksta_konkursa {
    
    public TP49_nema_teksta_konkursa() {
    }

   @Test
    public void registracijaKompanijaTest49() {
        ...
        String tip = "Posao";
        String rokZaPrijavu = "2022-01-15";
        String tekstKonkursa = "";
        ...
        String message = driver.findElement(By.name("tekstKon")).getAttribute("required");
