 ...
 * @author korisnik
 */
public class TP17_uneto_prazno_prezime {
    
    public TP17_uneto_prazno_prezime() {
    }
@Test
    public void registracijaStudentTest17() {
        ...
        driver.findElement(By.name("regStudentGodStudija")).sendKeys("2");
        ...
        String message = driver.findElement(By.name("regStudentIme")).getAttribute("required");
